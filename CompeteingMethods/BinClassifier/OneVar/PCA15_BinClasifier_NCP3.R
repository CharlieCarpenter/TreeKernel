...
pvalLHc31 <- lapply(hcDatL31, pcaTreeTest, 
                    formula.H0 = formula.H0,
                    groups = nGrp, ncp = ncp,
                    classifier = 'discrete')
...
pvalLHc32 <- lapply(hcDatL32, pcaTreeTest, 
                    formula.H0 = formula.H0,
                    groups = nGrp, ncp = ncp,
                    classifier = 'discrete')
...
pvalLHc30 <- lapply(hcDatL30, pcaTreeTest,
                    formula.H0 = formula.H0,
                    groups = nGrp, ncp = ncp,
                    classifier = 'discrete')
...
pvalLHc21 <- lapply(hcDatL21, pcaTreeTest, 
                    formula.H0 = formula.H0,
                    groups = nGrp, ncp = ncp,
                    classifier = 'discrete')
...
pvalLHc20 <- lapply(hcDatL20, pcaTreeTest, 
                    formula.H0 = formula.H0,
                    groups = nGrp, ncp = ncp,
                    classifier = 'discrete')
