...
## Project: MetaboGuru
##
## Purpose: Power simulations for simes competing method
##
...
covL <- lapply(1:nsim, function(x){
  data.frame(X1 = factor(rdunif(n, 4)),
...
pvalLHc41 <- lapply(hcDatL41, simesTreeTest, 
...
pvalLHc42 <- lapply(hcDatL42, simesTreeTest,  
                    formula.H0 = formula.H0,
                    groups=nGrp,
                    classifier='discrete')
...
pvalLHc40 <- lapply(hcDatL40, simesTreeTest, 
                    formula.H0 = formula.H0,
                    groups=nGrp,
                    classifier='discrete')
...
covL <- lapply(1:nsim, function(x){
  data.frame(X1 = factor(rdunif(n, 3)),
             X2 = runif(n, -0.15, 0.15),
             X3 = runif(n, -1, 1),
             X4 = rnorm(n, sd=5))
})
...
pvalLHc31 <- lapply(hcDatL31, simesTreeTest, 
                    formula.H0 = formula.H0,
                    groups=nGrp,
                    classifier='discrete')
...
pvalLHc32 <- lapply(hcDatL32, simesTreeTest, 
                    formula.H0 = formula.H0,
                    groups=nGrp,
                    classifier='discrete')
...
pvalLHc30 <- lapply(hcDatL30, simesTreeTest, 
                    formula.H0 = formula.H0,
                    groups=nGrp,
                    classifier='discrete')
...
covL <- lapply(1:nsim, function(x){
  data.frame(X1 = factor(rdunif(n, 2)),
             X2 = runif(n, -0.15, 0.15),
             X3 = runif(n, -1, 1),
             X4 = rnorm(n, sd=5))
})
...
pvalLHc21 <- lapply(hcDatL21, simesTreeTest, 
                    formula.H0 = formula.H0,
                    groups=nGrp,
                    classifier='discrete')
...
pvalLHc20 <- lapply(hcDatL20, simesTreeTest, 
                    formula.H0 = formula.H0,
                    groups=nGrp,
                    classifier='discrete')
